...
# ==========================================
# 🏄 MODE 2: THE SURFING FEED (DUAL-TAB SYSTEM)
# ==========================================
    ...
    with tab_want:
        ...
        if wants.empty:
            st.info("The requested pool is empty. Post what you are looking for so traders can find you!")
        else:
            cols = st.columns(3)
...
# ==========================================
# 📦 MODE 3: POST AN ITEM (ENFORCED LIMITS)
# ==========================================
...
# ==========================================
    ...
    with col_reg:
        ...
        reg_phone = st.text_input("International Phone Number (Include country code without special characters)")
        reg_city = st.text_input("Current Destination Hub City")
            ...
            if user_data["is_premium"]:
                ...
                st.markdown("""
                    <div style='border: 1px solid #E0E0E0; padding: 20px; border-radius: 8px;'>
                        ...
                        <ul>
                            <li><b>Unlimited Active Uploads</b></li>
                            <li><b>Global Surfing Boost</b></li>
...
# ==========================================
    ...
    with c1:
        ...
        st.code("Stop wasting money on shipping fees. Use GTrade Surf to trade items globally.", language="text")
    with c2:
        st.markdown("#### ✍️ Instagram / X Announcement")
        st.code("Say hello to the global circular trading loop 🌐 Deployed the MVP for GTrade Surf!", language="text")
    with c3:
        st.markdown("#### 💬 WhatsApp / DM Blast")
        st.code("Hey! I'm running early alpha testing for an application I built called GTrade Surf.", language="text")
...
# ==========================================
    ...
    st.write("Privacy policies and protection frameworks designed to meet processing standard rules.")
...
# ==========================================
    ...
    if input_key == ADMIN_PASSKEY:
        ...
        with tab_mod:
            ...
            if df.empty:
                ...
                for idx, row in df.iterrows():
                    col_item, col_action = st.columns(2)
                    with col_item:
                        st.markdown(f"**[{row['Post_Type']}]** {row['Item_Title']}")
                    with col_action:
        ...
        with tab_diag:
            ...
            st.info("System architecture is completely optimized and running clean.")
    elif input_key != "":
        st.error("🛑 Security Exception: Invalid Passkey Provided.")
